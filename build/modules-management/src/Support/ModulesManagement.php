...
namespace App\Build\ModulesManagement\Support;

use \Closure;
use Illuminate\Support\Facades\Log;
use App\Build\ModulesManagement\Events\ModuleDisabled;
use App\Build\ModulesManagement\Events\ModuleEnabled;
...
class ModulesManagement
{
    ...
    public function modifyModule($alias, array $data, \Closure $callback = null)
    {
        ...
        File::put($file, json_encode_prettify(array_merge($currentModule, $data)));
        if ($callback) {
