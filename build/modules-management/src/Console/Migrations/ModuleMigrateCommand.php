...
namespace App\Build\ModulesManagement\Console\Migrations;
...
class ModuleMigrateCommand extends Command
{
    ...
    {alias : Tên của module hoặc "all" cho tất cả module}';
     ...
     * @var string
     */
    protected $description = 'Run migration DB theo module';
